...
Currently working on fix for the qwen3.5-4b, gemma-4-31b and glm-4.5-air as I think I know the issue now. Still work but just double models because LMS bs.
...
Quickly did these up. They contain all/most quants currently available (4th of April 2026) including lmstudio-community but not MLX quants. Now able to update easily, so every month likely or when a new model comes out it will be getting done daily/weekly

## Models Done
Google Gemma 4 E2B, E4B, 26B-A4B, 31B | Qwen 3.5 9B, 35B-A3B, 122B-A10B, 397B-A17B | Qwen 3 (1st gen) | OpenAI GPT-OSS 20B | Z.ai GLM 4.7 Flash, 4.5 Air | NVIDIA Nemotron 3 Nano 4B, Nano 30B, Super | ByteDance Seed-OSS 36B | NousResearch Hermes 4 14B, 70B, 405B, Hermes 4.3 36B | MistralAI Mistral Small 4 | MiniMax M2.5
