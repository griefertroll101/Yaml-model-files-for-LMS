...
Quickly did these up. They contain all/most quants currently available (26th of May 2026) including lmstudio-community but not MLX quants. Now able to update easily, so every month likely or when a new model comes out it will be getting done daily/weekly
