...
## Models Done
Qwen 3.5 4B, 9B, 35B, 122B | OpenAI GPT-OSS 20B, 120B | Z.ai GLM 4.7-flash | Nvidia Nemotron-3-nano
...
If you do not know the username for the PC then follow the folders one by one i.e start in the Local Disk (C:) then click on the users folder then select the folder that doesn't have the name Default or Public. Once you have selected the use folder .lmstudio should be available to you
