...
If you do not know the username for the PC then follow the folders one by one i.e start in the Local Disk (C:) then click on the users folder then select the folder that doesn't have the name Default or Public. Once you have selected the %username% folder .lmstudio should be amoung the folders in that folder.
